...
emlrtContext emlrtContextGlobal = { true, false, 131418U, NULL, "data_filter",
 ...
 * Return Type  : void
 */
void data_filter_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *M;
  ...
  emxInit_real_T(&st, &M, 1, true);
  emxInit_real_T(&st, &data_out, 1, true);
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "M", M);

  /* Invoke the target function */
  data_filter(M, data_out);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(data_out);
 ...
 * Return Type  : void
 */
void data_filter_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void data_filter_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_data_filter_api.c
 *
 * [EOF]
 */
